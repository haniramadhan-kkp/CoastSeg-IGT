...
from coastseg.automation_widget import AutomationWidget
...
class UI_Models:
    ...
    def create_dashboard(self) -> None:
        ...
        # step 6 : Automation & Portal Export
        step_6 = VBox(
            [
                self.step_6_instr,
                self.automation_widget.container,
            ]
        )
    ...
    def _create_HTML_widgets(self) -> None:
        ...
        # step 6 : Automation & Portal Export
        self.step_6_instr = HTML(
            value="<h2>Step 6 : Automation & Portal Export</h2>\
            <b>Run Full Automation:</b> Click the button below to automatically predict tides, correct shorelines, and export all data for the Laravel Portal.\
            ",
            layout=Layout(margin="0px 0px 0px 0px"),
        )
