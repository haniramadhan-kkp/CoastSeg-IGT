...
class UI:
    ...
    def __init__(self, coastseg_map: Any, **kwargs: Any) -> None:
        ...
        # create the automation widget that controls the automation and portal export
        self.automation_widget = AutomationWidget(self.coastseg_map)
    ...
    def create_dashboard(self) -> Any:
        ...
        automation_row = widgets.VBox([line, self.automation_widget.container])
